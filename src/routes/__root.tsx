...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Editorial insights on AI marketing, engineering, and the systems changing how modern teams ship campaigns." },
      { name: "author", content: "Supernova" },
      ...
      { name: "twitter:site", content: "@supernova" },
    ],
    links: [
